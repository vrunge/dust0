...
#' @param model the underlying model of the data. defaults is "gauss". available models: c("gauss", "poisson", "exp", "geom", "bern", "binom", "negbin")
#' @param method the method for handling the indices and pruning tests in the algorithm. defaults to "fastest", which returns the fastest method available on input model.
...
#' @param nbLoops number of iterations in the optimization algorithm for maximizing the dual function
