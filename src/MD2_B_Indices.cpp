...
Indices_MD2::Indices_MD2() : nb_l(1), nb_r(0), nb_max(1) {}
Indices_MD2::Indices_MD2(const unsigned int& nb_l_, const unsigned int& nb_r_) :
...
VariableIndices_MD2::VariableIndices_MD2(const unsigned int& nb_l_, const unsigned int& nb_r_) :
  Indices_MD2(nb_l_, nb_r_)  { }
...
std::vector<unsigned int> VariableIndices_MD2::get_constraints_l()
{
  return std::vector(begin, current);
}
std::vector<unsigned int> VariableIndices_MD2::get_constraints_r()
{
...
RandomIndices_MD2::RandomIndices_MD2(const unsigned int& nb_l_, const unsigned int& nb_r_)
  : Indices_MD2(nb_l_, nb_r_)
...
std::vector<unsigned int> RandomIndices_MD2::get_constraints_l()
{
...
std::vector<unsigned int> RandomIndices_MD2::get_constraints_r()
{
  std::vector<unsigned int> constraints;
