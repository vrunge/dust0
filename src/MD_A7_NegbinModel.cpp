...
Negbin_MD::Negbin_MD(int dual_max, bool random_constraint, Nullable<int> nbLoops)
...
double Negbin_MD::dualMax(arma::colvec& a, arma::colvec& b, double& c, double& d, double& e, double& f) const
{
  return 0.;
}
